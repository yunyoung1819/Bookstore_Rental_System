...
<body>
                    ...
                    <div class="col-md">
                        <div class="card">
                            <form role="form" method="post">
                                <div class="card-body">
                                    <h4 class="card-title">Register Board</h4>
                                    ...
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Writer</label>
                                        <div class="col-sm-9">
    ...
    <!-- This Page JS -->
    <script src="<c:url value="/resources/assets/libs/inputmask/dist/min/jquery.inputmask.bundle.min.js"/>"></script>
    <script src="<c:url value="/resources/dist/js/pages/mask/mask.init.js"/>"></script>
    <script src="<c:url value="/resources/assets/libs/select2/dist/js/select2.full.min.js"/>"></script>
    <script src="<c:url value="/resources/assets/libs/select2/dist/js/select2.min.js"/>"></script>
    <script src="<c:url value="/resources/assets/libs/jquery-asColor/dist/jquery-asColor.min.js"/>"></script>
    <script src="<c:url value="/resources/assets/libs/jquery-asGradient/dist/jquery-asGradient.js"/>"></script>
    <script src="<c:url value="/resources/assets/libs/jquery-asColorPicker/dist/jquery-asColorPicker.min.js"/>"></script>
    <script src="<c:url value="/resources/assets/libs/jquery-minicolors/jquery.minicolors.min.js"/>"></script>
    <script src="<c:url value="/resources/assets/libs/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js"/>"></script>
    <!-- <script src="<c:url value="/resources/assets/libs/quill/dist/quill.min.js"/>"></script> -->
    <script>
        //***********************************//
        // For select 2
        //***********************************//
